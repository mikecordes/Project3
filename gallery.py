...
# Create a select box to chose a park to support
parks1 = st.sidebar.selectbox('Select a Park to Support', parks)

# Create a slider for NFTs to buy
...
# Write the park name to the sidebar
st.sidebar.write(parks2)

# Identify the total donation
donation = park_database[parks1][3]

# Write the total donation
